...
-- Free plan - show crowns and sample data
...
-- Basic plan - some crowns, some sample data
...
-- Pro plan - limited crowns, no sample data
...
-- Premium plan - no crowns, full features
...
-- Satellite plan - no crowns, full features
...
-- Driving plan - no crowns, full features
