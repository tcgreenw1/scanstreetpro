...
// Mock functions defined inline to avoid import issues
const mockToggleUserActive = async (userId: string, isActive: boolean) => {
  console.log(`Mock: Toggle user ${userId} active state to ${isActive}`);
  return Promise.resolve();
};

const mockUpdateOrganizationPlan = async (orgId: string, plan: string) => {
...
const mockDiagnoseUser = async (email: string, password: string) => {
...
const mockCreateUserInSupabase = async (email: string, password: string, userData: any) => {
...
const mockDeleteOrganization = async (orgId: string) => {
  console.log(`Mock: Delete organization ${orgId}`);
  return Promise.resolve();
};

const mockUpdateUserRole = async (userId: string, role: string) => {
  console.log(`Mock: Update user ${userId} role to ${role}`);
  return Promise.resolve();
};

const mockSwitchOrganizationPlan = async (orgId: string, fromPlan: string, toPlan: string) => {
  console.log(`Mock: Switch organization ${orgId} from ${fromPlan} to ${toPlan}`);
  return Promise.resolve();
};

const mockExportData = async (type: 'users' | 'organizations') => {
