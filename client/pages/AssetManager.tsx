...
export default function AssetManager() {
  ...
  return (
    ...
    >
      ...
      {userPlan === 'free' && planState.disableAssetManagement && (
        <div className="glass-card p-6 rounded-xl border-amber-200/50 bg-gradient-to-r from-amber-50/80 to-orange-50/80 dark:from-amber-900/30 dark:to-orange-900/30">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-amber-800 dark:text-amber-200">Asset Management Disabled</h3>
                <p className="text-amber-700 dark:text-amber-300">
                  Upgrade to Basic Plan to unlock full asset management, real data tracking, and editing capabilities.
                </p>
              </div>
            </div>
            <Link to="/pricing">
